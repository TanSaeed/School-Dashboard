    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //HERE: This code was edited at the start to allow the SuperAdmin to exist into the DB, before commenting out creation of SuperAdmin and allowing users(students)
                    //to register normally and take tests. 
        ...
        //Instructions for when the SuperAdmins creates a teacher account through his dashboard instead of a normal create account register
        ...
        public async Task<ActionResult> RegisterAdmin(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await UserManager.AddToRoleAsync(user.Id, "canEdit"); //Allows Teachers that the Super Admin added to create tests. 
                    //await UserManager.AddToRoleAsync(user.Id, "CanManageUsers");
                    await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
